...
after_install= ["thirvusoft.thirvusoft_customizations.custom.python.role.create_custom_role","thirvusoft.thirvusoft.thirvusoft_customizations.custom.python.default.create_custom_meeting"]
