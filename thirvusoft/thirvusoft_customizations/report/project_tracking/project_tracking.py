...
def get_columns(filters):
	columns = [
		...
		_("Total Development Hours")+":Float:100",
		_("Total Implementation Hours")+":Float:100",
		_("Total Fullflow Testing Hours")+":Float:100",
		_("Total Demo Hours")+":Float:100",
		_("Total Development Testing Hours")+":Float:100",
		_("Total Bug Fixing Hours")+":Float:100",
		_("Total Fullflow Checking Hours")+":Float:100",
		_("Total Expected Hours")+":Float:100",
		_("Total Actual Hours")+":Float:100",
		_("Total Exceeded Hours")+":Float:100",
	]
	return columns